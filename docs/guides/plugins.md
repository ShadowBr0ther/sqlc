...
- name: greeter
  wasm:
    url: https://github.com/ShadowBr0ther/sqlc-gen-greeter/releases/download/v0.1.0/sqlc-gen-greeter.wasm
...
- [sqlc-gen-greeter](https://github.com/ShadowBr0ther/sqlc-gen-greeter)
  - A WASM plugin (written in Rust) that outputs a friendly message
- [wasm_plugin_sqlc_gen_greeter](https://github.com/ShadowBr0ther/sqlc/tree/main/internal/endtoend/testdata/wasm_plugin_sqlc_gen_greeter)
...
For a complete working example see the following files:
- [sqlc-gen-json](https://github.com/ShadowBr0ther/sqlc/tree/main/cmd/sqlc-gen-json)
  - A process-based plugin that serializes the CodeGenRequest to JSON
- [process_plugin_sqlc_gen_json](https://github.com/ShadowBr0ther/sqlc/tree/main/internal/endtoend/testdata/process_plugin_sqlc_gen_json)
