...
- name: py
  wasm:
    url: https://github.com/ShadowBr0ther/sqlc-gen-python/releases/download/v0.16.0-alpha/sqlc-gen-python.wasm
...
> Removed in v1.17.0 and replaced by the [sqlc-gen-kotlin](https://github.com/ShadowBr0ther/sqlc-gen-kotlin) plugin. Follow the [migration guide](../guides/migrating-to-sqlc-gen-kotlin) to switch.
...
> Removed in v1.17.0 and replaced by the [sqlc-gen-python](https://github.com/ShadowBr0ther/sqlc-gen-python) plugin. Follow the [migration guide](../guides/migrating-to-sqlc-gen-python) to switch.
