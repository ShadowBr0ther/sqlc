...
remote-proto:
	protoc \
		--go_out=. --go_opt="Minternal/remote/gen.proto=github.com/ShadowBr0ther/sqlc/internal/remote" --go_opt=module=github.com/ShadowBr0ther/sqlc \
        --go-grpc_out=. --go-grpc_opt="Minternal/remote/gen.proto=github.com/ShadowBr0ther/sqlc/internal/remote" --go-grpc_opt=module=github.com/ShadowBr0ther/sqlc \
